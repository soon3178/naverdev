...
@WebServlet(name = "MusicInsert", urlPatterns = { "/MusicInsert.do" })
public class MusicInsertServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=dao.insertMusic(music);
		
		request.setAttribute("result", result);
		RequestDispatcher rd = request.getRequestDispatcher("/manager/musicInsert.jsp");
